...
public class KnowledgeScreen6 implements Screen, InputProcessor {

	private Math game;
	private InputProcessor processor;
	private Texture mainScreen = new Texture("KS6.png");
	private Texture playGame = new Texture("PLAYbutton.png");
	
	
	
	public static Music musicEye;
	
	public KnowledgeScreen6(Math game)
	{
		this.game = game;
		processor = this;
	...
	public boolean touchDown(int screenX, int screenY, int pointer, int button) {
		if(screenX > 750 && screenX < 1000 && screenY < (game.height - 80 ) && screenY > (game.height -80 -30 ) )
		{
			...
			musicEye = Gdx.audio.newMusic(Gdx.files.internal("eyes.mp3"));
