...
public class KnowledgeScreen4 implements Screen, InputProcessor {

	private Math game;
	private InputProcessor processor;
	private Texture mainScreen = new Texture("KS4.png");
	private Texture playGame = new Texture("PLAYbutton.png");
	
	
	
	public static Music musicTev;
	
	public KnowledgeScreen4(Math game)
	{
		this.game = game;
		processor = this;
	...
	public boolean touchDown(int screenX, int screenY, int pointer, int button) {
		if(screenX > 750 && screenX < 1000 && screenY < (game.height - 80 ) && screenY > (game.height -80 -30 ) )
		{
			...
			musicTev = Gdx.audio.newMusic(Gdx.files.internal("tevo.mp3"));
