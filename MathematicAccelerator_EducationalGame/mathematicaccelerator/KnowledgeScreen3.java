...
public class KnowledgeScreen3 implements Screen, InputProcessor {

	private Math game;
	private InputProcessor processor;
	private Texture mainScreen = new Texture("KS3.png");
	private Texture playGame = new Texture("PLAYbutton.png");
	
	
	
	public static Music musicEcl;
	
	public KnowledgeScreen3(Math game)
	{
		this.game = game;
		processor = this;
	...
	public boolean touchDown(int screenX, int screenY, int pointer, int button) {
		if(screenX > 750 && screenX < 1000 && screenY < (game.height - 80 ) && screenY > (game.height -80 -30 ) )
		{
			...
			musicEcl = Gdx.audio.newMusic(Gdx.files.internal("spirit.mp3"));
